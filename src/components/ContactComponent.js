...
class Contact extends Component {
	...
	validate(firstname, lastname, telnum, email) {
		...
		// regular expression: all the strings should be all number characters
		const reg = /^\d+$/;
		// check telnum see if it follows with regular expression above -> telnum should be all numbers
		if (this.state.touched.telnum && !reg.test(telnum)) errors.telnum = 'Tel. Number should contains only numbers';
			...
			<div className="container">
				...
				<div className="row row-content">
					...
					<div className="col-12 col-md-9">
						{/* onSubmit is tied to handleSubmit function */}
						<Form onSubmit={this.handleSubmit}>
							...
							<FormGroup row>
								{/* offset: no label, will push right 2 unit */}
